...
export async function POST(request) {
  try {
    ...
    // If there are execution results with screenshots, handle them
    if (executionResults && executionResults.screenshots && executionResults.screenshots.length > 0) {
      // Upload screenshots and update execution results with URLs
      ...
      // Store execution results in test_executions table (optional for MVP)
      // For now, we'll just return the test with screenshot URLs
      executionResults.screenshots = uploadedScreenshots;
    }
